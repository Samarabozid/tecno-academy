...
import tecno.academy.TecnoAcademy.Models.TriviaQuestion;
import tecno.academy.TecnoAcademy.Models.TriviaQuizHelper;
...
//        tb = Typeface.createFromAsset(getAssets(), "fonts/TitilliumWeb-Bold.ttf");
  //      sb = Typeface.createFromAsset(getAssets(), "fonts/shablagooital.ttf");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, HomeGameScreen.class);
        startActivity(intent);
        finish();
    }
